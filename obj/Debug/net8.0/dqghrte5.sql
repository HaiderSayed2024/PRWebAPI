...
VALUES (N'567acefc-ac12-4379-8658-f2c6269e4d97', N'1', N'Admin', N'Admin'),
(N'73f0efd6-7c08-4601-920c-126d1dd36e0c', N'1', N'Admin', N'User'),
(N'a8fe6f40-fbc3-470b-9c08-8c81dd4fccea', N'1', N'Admin', N'HR');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AspNetRoles]'))
